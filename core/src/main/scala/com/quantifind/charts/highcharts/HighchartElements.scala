...
object SeriesType {
  type Type = String
  val (area, areaspline, bar, boxplot, column, heatmap, line, pie, scatter, spline, treemap) = ("area", "areaspline", "bar", "boxplot", "column", "heatmap", "line", "pie", "scatter", "spline", "treemap")
